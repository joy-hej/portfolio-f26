import './SquiggleMark.css'

/** Squiggle mark (replaces former ⟡). Cursor hover rotates this same glyph 120°. */
...
export default function SquiggleMark({
  ...
  return (
    ...
    >
      ...
      <path
        className={drawOnMount ? 'squiggle-mark__path--draw' : undefined}
        d={SQUIGGLE_DEFAULT_PATH}
        pathLength={drawOnMount ? 1 : undefined}
        stroke={stroke}
        strokeWidth="2.4"
        strokeLinecap="round"
